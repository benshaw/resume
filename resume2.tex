...
{Developing greenfield as well as maintenance and refactoring of existing API's in a micro-service data processing architecture for early stage startup. Mentored junior engineers and worked with management in building a successful team and software development process. \\
